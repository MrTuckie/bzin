...
#define TOPICO_PUBLISH   "bzrecebe"    //tópico MQTT de envio de informações para Broker
                                                   ...
                                                   //            de outra pessoa.
#define ID_MQTT  "bzLampada1"     //id mqtt (para identificação de sessão)
...
// WIFI
//const char* SSID = "VIVOFIBRA-3BEB"; // SSID / nome da rede WI-FI que deseja se conectar
//const char* PASSWORD = "7223363BEB"; // Senha da rede WI-FI que deseja se conectar
